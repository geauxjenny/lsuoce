...
<tiles:insert beanName="TMain" beanScope="request" flush="true">   
  <tiles:put name="pageId" value="pageInactiveCorporateLandingPage"/>
  <tiles:put name="title"><c:out value="${schoolName}"/></tiles:put>
  <tiles:put name="header2Sub1" value="" />
  <tiles:put name="content1Sub1" value="/restricted/corporate/learnerPortal/inactiveLandingPage.jsp" />  
</tiles:insert>

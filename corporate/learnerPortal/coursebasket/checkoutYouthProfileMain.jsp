...
<tiles:insert beanName="TMain" beanScope="request" flush="true">    
    <tiles:put name="pageId" value="pageCLPCheckoutYouthProfile"/>    
    ...
    <tiles:put name="content7Sub1" value="/restricted/portal/student/checkoutYouthProfile.jsp" />    
    <tiles:put name="pageScriptsDelayLoad" value="/restricted/portal/student/studentProfileDelayLoadScripts.jsp" />
</tiles:insert>

...
<tiles:insert beanName="TMain" beanScope="request" flush="true">    
    ...
    <tiles:put name="pageHeader"><bean:message key="public.shoppingCart.application.pageHeader" /></tiles:put>    
    ...
    <tiles:put name="content1Sub1" value="/restricted/checkout/registrationApplication.jsp" />

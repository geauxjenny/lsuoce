...
<tiles:insert beanName="TMain" beanScope="request" flush="true">    
    <tiles:put name="pageId" value="pageCLPPaymentOptionsCompleted"/>    
    ...
    <tiles:put name="content1Sub1" value="/restricted/corporate/learnerPortal/coursebasket/paymentMethodComplete.jsp" />                                                         
</tiles:insert>
